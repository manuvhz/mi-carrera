...
const champion: CareerPlayer = {
  ...
  stats: { talent: 99, technique: 99, fitness: 99, discipline: 99, confidence: 99, resilience: 99, reputation: 90, family: 60, community: 60, finances: 12, goals: 120, assists: 55, matches: 240, trophies: 2 },
}
