...
export type FootballRegionId = 'argentina' | 'brazil' | 'england' | 'spain' | 'italy' | 'germany' | 'france'
...
export const FOOTBALL_REGIONS: Array<{ id: FootballRegionId; name: string; league: string; flag: string }> = [
  ...
  { id: 'brazil', name: 'Brasil', league: 'Brasileirão Série A', flag: '🇧🇷' },
...
export const REAL_CLUBS: RealClub[] = [
  ...
  { id: 'flamengo', name: 'Clube de Regatas do Flamengo', shortName: 'Flamengo', city: 'Río de Janeiro', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/flamengo.png', colors: ['#e31b23', '#111111'], prestige: 92, academy: 91, source: 'https://pt.wikipedia.org/wiki/Clube_de_Regatas_do_Flamengo', license: IDENTIFICATION_LICENSE },
  { id: 'palmeiras', name: 'Sociedade Esportiva Palmeiras', shortName: 'Palmeiras', city: 'São Paulo', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/palmeiras.png', colors: ['#006437', '#ffffff'], prestige: 93, academy: 92, source: 'https://pt.wikipedia.org/wiki/Sociedade_Esportiva_Palmeiras', license: IDENTIFICATION_LICENSE },
  { id: 'corinthians', name: 'Sport Club Corinthians Paulista', shortName: 'Corinthians', city: 'São Paulo', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/corinthians.png', colors: ['#ffffff', '#111111'], prestige: 89, academy: 90, source: 'https://pt.wikipedia.org/wiki/Sport_Club_Corinthians_Paulista', license: IDENTIFICATION_LICENSE },
  { id: 'sao-paulo', name: 'São Paulo Futebol Clube', shortName: 'São Paulo', city: 'São Paulo', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/sao-paulo.png', colors: ['#e71c23', '#111111'], prestige: 90, academy: 96, source: 'https://pt.wikipedia.org/wiki/S%C3%A3o_Paulo_Futebol_Clube', license: IDENTIFICATION_LICENSE },
  { id: 'santos', name: 'Santos Futebol Clube', shortName: 'Santos', city: 'Santos', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/santos.png', colors: ['#ffffff', '#111111'], prestige: 86, academy: 99, source: 'https://pt.wikipedia.org/wiki/Santos_Futebol_Clube', license: IDENTIFICATION_LICENSE },
  { id: 'fluminense', name: 'Fluminense Football Club', shortName: 'Fluminense', city: 'Río de Janeiro', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/fluminense.svg', colors: ['#7a263a', '#00613c'], prestige: 87, academy: 92, source: 'https://pt.wikipedia.org/wiki/Fluminense_Football_Club', license: IDENTIFICATION_LICENSE },
  { id: 'botafogo', name: 'Botafogo de Futebol e Regatas', shortName: 'Botafogo', city: 'Río de Janeiro', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/botafogo.png', colors: ['#111111', '#ffffff'], prestige: 86, academy: 88, source: 'https://pt.wikipedia.org/wiki/Botafogo_de_Futebol_e_Regatas', license: IDENTIFICATION_LICENSE },
  { id: 'vasco-da-gama', name: 'Club de Regatas Vasco da Gama', shortName: 'Vasco da Gama', city: 'Río de Janeiro', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/vasco-da-gama.png', colors: ['#111111', '#ffffff'], prestige: 84, academy: 88, source: 'https://pt.wikipedia.org/wiki/Club_de_Regatas_Vasco_da_Gama', license: IDENTIFICATION_LICENSE },
  { id: 'gremio', name: 'Grêmio Foot-Ball Porto Alegrense', shortName: 'Grêmio', city: 'Porto Alegre', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/gremio.png', colors: ['#0d80bf', '#111111'], prestige: 88, academy: 92, source: 'https://pt.wikipedia.org/wiki/Gr%C3%AAmio_Foot-Ball_Porto_Alegrense', license: IDENTIFICATION_LICENSE },
  { id: 'internacional', name: 'Sport Club Internacional', shortName: 'Internacional', city: 'Porto Alegre', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/internacional.svg', colors: ['#e30613', '#ffffff'], prestige: 88, academy: 93, source: 'https://pt.wikipedia.org/wiki/Sport_Club_Internacional', license: IDENTIFICATION_LICENSE },
  { id: 'atletico-mineiro', name: 'Clube Atlético Mineiro', shortName: 'Atlético Mineiro', city: 'Belo Horizonte', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/atletico-mineiro.png', colors: ['#111111', '#ffffff'], prestige: 89, academy: 87, source: 'https://pt.wikipedia.org/wiki/Clube_Atl%C3%A9tico_Mineiro', license: IDENTIFICATION_LICENSE },
  { id: 'cruzeiro', name: 'Cruzeiro Esporte Clube', shortName: 'Cruzeiro', city: 'Belo Horizonte', country: 'Brasil', leagueId: 'brazil', league: 'Brasileirão Série A', crest: 'clubs/cruzeiro.png', colors: ['#164194', '#ffffff'], prestige: 86, academy: 92, source: 'https://pt.wikipedia.org/wiki/Cruzeiro_Esporte_Clube', license: IDENTIFICATION_LICENSE },
  ...
  { id: 'newcastle', name: 'Newcastle United', shortName: 'Newcastle', city: 'Newcastle', country: 'Inglaterra', leagueId: 'england', league: 'Premier League', crest: 'clubs/newcastle.png', colors: ['#111111', '#ffffff'], prestige: 87, academy: 87, source: crestSource(67), license: IDENTIFICATION_LICENSE },
  { id: 'aston-villa', name: 'Aston Villa', shortName: 'Aston Villa', city: 'Birmingham', country: 'Inglaterra', leagueId: 'england', league: 'Premier League', crest: 'clubs/aston-villa.png', colors: ['#670e36', '#95bfe5'], prestige: 86, academy: 89, source: crestSource(58), license: IDENTIFICATION_LICENSE },
  ...
  { id: 'villarreal', name: 'Villarreal CF', shortName: 'Villarreal', city: 'Villarreal', country: 'España', leagueId: 'spain', league: 'LALIGA', crest: 'clubs/villarreal.png', colors: ['#ffe667', '#005187'], prestige: 85, academy: 90, source: crestSource(94), license: IDENTIFICATION_LICENSE },
  { id: 'real-betis', name: 'Real Betis', shortName: 'Real Betis', city: 'Sevilla', country: 'España', leagueId: 'spain', league: 'LALIGA', crest: 'clubs/real-betis.png', colors: ['#0bb363', '#ffffff'], prestige: 83, academy: 87, source: crestSource(90), license: IDENTIFICATION_LICENSE },
  ...
  { id: 'lazio', name: 'SS Lazio', shortName: 'Lazio', city: 'Roma', country: 'Italia', leagueId: 'italy', league: 'Serie A', crest: 'clubs/lazio.png', colors: ['#87d8f7', '#ffffff'], prestige: 85, academy: 85, source: crestSource(110), license: IDENTIFICATION_LICENSE },
  { id: 'fiorentina', name: 'ACF Fiorentina', shortName: 'Fiorentina', city: 'Florencia', country: 'Italia', leagueId: 'italy', league: 'Serie A', crest: 'clubs/fiorentina.png', colors: ['#482e92', '#ffffff'], prestige: 82, academy: 88, source: crestSource(99), license: IDENTIFICATION_LICENSE },
  ...
  { id: 'borussia-monchengladbach', name: 'Borussia Mönchengladbach', shortName: 'Mönchengladbach', city: 'Mönchengladbach', country: 'Alemania', leagueId: 'germany', league: 'Bundesliga', crest: 'clubs/borussia-monchengladbach.png', colors: ['#111111', '#ffffff'], prestige: 80, academy: 89, source: crestSource(18), license: IDENTIFICATION_LICENSE },
  { id: 'freiburg', name: 'SC Freiburg', shortName: 'Freiburg', city: 'Friburgo', country: 'Alemania', leagueId: 'germany', league: 'Bundesliga', crest: 'clubs/freiburg.png', colors: ['#e2001a', '#111111'], prestige: 79, academy: 87, source: crestSource(17), license: IDENTIFICATION_LICENSE },
  ...
  { id: 'lens', name: 'RC Lens', shortName: 'Lens', city: 'Lens', country: 'Francia', leagueId: 'france', league: 'Ligue 1', crest: 'clubs/lens.png', colors: ['#e52521', '#f4d323'], prestige: 80, academy: 87, source: crestSource(546), license: IDENTIFICATION_LICENSE },
  { id: 'rennes', name: 'Stade Rennais', shortName: 'Rennes', city: 'Rennes', country: 'Francia', leagueId: 'france', league: 'Ligue 1', crest: 'clubs/rennes.png', colors: ['#e30613', '#111111'], prestige: 82, academy: 96, source: crestSource(529), license: IDENTIFICATION_LICENSE },
]
